          ...
          datasets: [
            {
              ...
              data: [
                ...
                percentiles.averagePostsInterval === 100 ? 0 : percentiles.averagePostsInterval,
                percentiles.averageLikeInterval === 100 ? 0 : percentiles.averageLikeInterval,
                percentiles.averageRepostInterval === 100 ? 0 : percentiles.averageRepostInterval,
